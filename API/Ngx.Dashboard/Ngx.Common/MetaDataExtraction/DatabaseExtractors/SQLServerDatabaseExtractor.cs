...
namespace Ngx.Common.MetaDataExtraction.DatabaseExtractors
{
    ...
    {
        public override void GetDatabases(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
            GetDatabasesBySql(project);
        }

        public override void GetDatabasesBySql(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
            ...
            {
                Entities.MetaDataSchema.Database db = new Ngx.Common.Entities.MetaDataSchema.Database();
        ...
        #region Tables
        public override void GetTables(Ngx.Common.Entities.MetaDataSchema.Database database)
        {
            System.Data.DataTable tables = new DataTable();
            ...
            foreach (DataRow row in tables.Rows)
            {
                Entities.MetaDataSchema.Table tbl = new Ngx.Common.Entities.MetaDataSchema.Table();
        ...
        public override void GetTables(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
            foreach (Entities.MetaDataSchema.Database dbase in project.Databases)
            {
                ...
                OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(dbase.Name,"Tables","Database"));
                dbase.Tables.Clear();
                foreach (DataRow row in tables.Rows)
                {
                ...
                OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(dbase.Name, "Tables","Database"));
                tables.Dispose();
            }
            GC.Collect();
        }
        ...
        #region Columns
        public override void GetColumns(Ngx.Common.Entities.MetaDataSchema.Table table)
        {
            System.Data.DataTable tables = new DataTable();
            System.Data.DataTable sqlServerTable = new DataTable();
            ...
            OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(table.Name,"Columns","Table"));
            table.Columns.Clear();
            ...
            OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(table.Name,"Columns","Table"));
            GC.Collect();
        }

        public override void GetColumns(Ngx.Common.Entities.MetaDataSchema.View view)
        {
            ...
            OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(view.Name, "Columns","View"));
            view.Columns.Clear();
            ...
            OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(view.Name, "Columns","View"));
            GC.Collect();
        }

        public override void GetColumns(Ngx.Common.Entities.MetaDataSchema.Database database)
        {
            System.Data.DataTable tables = new DataTable();
            System.Data.DataTable sqlServerTable = new DataTable();
            //System.Data.DataTable sqlObjectsTable = new DataTable();
        ...
        #region Relations
        public override void GetParentRelations(Ngx.Common.Entities.MetaDataSchema.Table table)
        {
            ...
            List<Ngx.Common.Entities.MetaDataSchema.RelationShip> _ParentRelationShips = new List<Ngx.Common.Entities.MetaDataSchema.RelationShip>();
            ...
            {
                Ngx.Common.Entities.MetaDataSchema.RelationShip relationShip = new Entities.MetaDataSchema.RelationShip();
        ...
        public override void GetChildRelations(Ngx.Common.Entities.MetaDataSchema.Table table)
        {
...
", table.ParentDatabase.NameForQuery, table.Schema, table.Name);
            List<Ngx.Common.Entities.MetaDataSchema.RelationShip> _ChildRelationShips = new List<Ngx.Common.Entities.MetaDataSchema.RelationShip>();
            relations.Load(table.ParentDatabase.ParentProject.ExtractorManager.SelectStatement(query), LoadOption.OverwriteChanges);
            foreach (DataRow row in relations.Rows)
            {
                Ngx.Common.Entities.MetaDataSchema.RelationShip relationShip = new Entities.MetaDataSchema.RelationShip();
        ...
        public override void GetTableRelations(Ngx.Common.Entities.MetaDataSchema.Table table)
        {
        ...
        public override void GetTableRelations(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
        ...
        #region Views
        public override void GetViews(Ngx.Common.Entities.MetaDataSchema.Database database)
        {
            System.Data.DataTable views = new DataTable();
            System.Data.DataTable sqlServerTable = new DataTable();
            ...
            foreach (DataRow row in views.Rows)
            {
                Entities.MetaDataSchema.View view = new Ngx.Common.Entities.MetaDataSchema.View();
        ...
        public override void GetViews(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
            foreach (Entities.MetaDataSchema.Database database in project.Databases)
            {
                ...
                views.Load(database.ParentProject.ExtractorManager.SelectStatement("Select * From " + database.NameForQuery + "INFORMATION_SCHEMA.VIEWS Order By Table_Name"), LoadOption.OverwriteChanges);
                sqlServerTable.Load(database.ParentProject.ExtractorManager.SelectStatement("Select * From " + database.NameForQuery + "sys.all_objects Where Type_Desc = 'VIEW'"), LoadOption.OverwriteChanges);
                OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(database.Name, "Views","Database"));
                database.Views.Clear();
                foreach (DataRow row in views.Rows)
                {
                    Entities.MetaDataSchema.View view = new Ngx.Common.Entities.MetaDataSchema.View();
                ...
                OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(database.Name, "Views","Database"));
                views.Dispose();
            }
            GC.Collect();
        }
        ...
        #region Procedures
        public override void GetStoredProcedures(Ngx.Common.Entities.MetaDataSchema.Database database)
        {
            ...
            {
                Entities.MetaDataSchema.StoredProcedure storedProcedure = new Ngx.Common.Entities.MetaDataSchema.StoredProcedure();
        ...
        public override void GetStoredProcedures(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
            foreach (Entities.MetaDataSchema.Database database in project.Databases)
            {
                ...
                procedures.Load(database.ParentProject.ExtractorManager.SelectStatement("Select * From " + database.NameForQuery + "INFORMATION_SCHEMA.ROUTINES where ROUTINE_TYPE = 'PROCEDURE'"), LoadOption.OverwriteChanges);
                sqlServerTable.Load(database.ParentProject.ExtractorManager.SelectStatement("Select * From " + database.NameForQuery + "sys.all_objects Where [Type] = 'P'"), LoadOption.OverwriteChanges);
                OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(database.Name, "Stored Procedures", "Database"));
                database.StoredProcedures.Clear();
                foreach (DataRow row in procedures.Rows)
                {
                    Entities.MetaDataSchema.StoredProcedure storedProcedure = new Ngx.Common.Entities.MetaDataSchema.StoredProcedure();
                ...
                OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(database.Name, "Stored Procedures", "Database"));
                procedures.Dispose();
            }
            GC.Collect();
        }
        ...
        #region Functions
        public override void GetFunctions(Ngx.Common.Entities.MetaDataSchema.Database database)
        {
            System.Data.DataTable functions = new DataTable();
            System.Data.DataTable sqlServerTable = new DataTable();
            ...
            foreach (DataRow row in functions.Rows)
            {
                Entities.MetaDataSchema.Function function = new Ngx.Common.Entities.MetaDataSchema.Function();
        ...
        public override void GetFunctions(Ngx.Common.Entities.MetaDataSchema.Project project)
        {
            foreach (Entities.MetaDataSchema.Database database in project.Databases)
            {
                ...
                functions.Load(database.ParentProject.ExtractorManager.SelectStatement("Select * From " + database.NameForQuery + "INFORMATION_SCHEMA.ROUTINES where ROUTINE_TYPE = 'FUNCTION'"), LoadOption.OverwriteChanges);
                sqlServerTable.Load(database.ParentProject.ExtractorManager.SelectStatement("Select * From " + database.NameForQuery + "sys.all_objects Where [Type] = 'FN'"), LoadOption.OverwriteChanges);
                OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(database.Name, "Functions","Database"));
                database.Functions.Clear();
                foreach (DataRow row in functions.Rows)
                {
                    Entities.MetaDataSchema.Function function = new Ngx.Common.Entities.MetaDataSchema.Function();
                ...
                OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(database.Name, "Functions","Database"));
                functions.Dispose();
            }
            GC.Collect();
        }

        public override void GetFunctionParameters(Ngx.Common.Entities.MetaDataSchema.Function function)
        {
            System.Data.DataTable functions = new DataTable();
            ...
            OnStartLoading(new Ngx.Common.Events.LoadingEventArgs(function.Name, "Parameters","Function"));
            ...
            OnEndLoading(new Ngx.Common.Events.LoadingEventArgs(function.Name, "Parameters","Function"));
            GC.Collect();
        }

...
using Ngx.Dashboard.Api.Middleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen((c) =>
            {
                ...
                c.IncludeXmlComments(Path.Combine(PlatformServices.Default.Application.ApplicationBasePath, "Ngx.Dashboard.Api.xml"));
            });
        }

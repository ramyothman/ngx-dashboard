...
namespace Festo.Common.Entities.MetaDataSchema
{
    ...
    public class Project : Entities.Entity
    {
        ...
        private Festo.Common.MetaDataExtraction.ExtractorManager _extractorManager = new Festo.Common.MetaDataExtraction.ExtractorManager();
        [XmlIgnoreAttribute]
        public Festo.Common.MetaDataExtraction.ExtractorManager ExtractorManager
        {

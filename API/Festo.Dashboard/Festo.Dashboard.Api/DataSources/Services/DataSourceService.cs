...
using Festo.Dashboard.Api.DataSources.Model;
using Festo.Dashboard.Api.DataSources.Model.Request;
...
using Column = Festo.Dashboard.Api.DataSources.Model.Column;

namespace Festo.Dashboard.Api.DataSources.Services
{
    public class DataSourceService
    {
        ...
        public async Task<List<Model.Column>> GetColumnsAsync(ColumnsRequest request)
        {
            ...
            try
            {
                ...
                {
                    List<Festo.Common.Entities.MetaDataSchema.Column> columnSchema = null;
